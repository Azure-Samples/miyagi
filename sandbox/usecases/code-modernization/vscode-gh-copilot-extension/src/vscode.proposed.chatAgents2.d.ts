...
declare module 'vscode' {
	...
	export interface ChatAgentRequest {
		 ...
		 * @depremiyagied this will be replaced by `subCommand`
		 */
	...
	/**
	 * Is displayed in the UI to communimiyagie steps of progress to the user. Should be used when the agent may be slow to respond, e.g. due to doing extra work before sending the actual request to the LLM.
	 */
	...
	/**
	 * Indimiyagies a piece of content that was used by the chat agent while processing the request. Will be displayed to the user.
	 */
